<template>
  ...
  <div class="wrapper cropper_box clearfix" :class="{'hide_left': isFirst }">
    ...
    <div class="success successImg" v-show="url || uploadedFileData.url" @mouseenter="showOperation=true"  @mouseleave="showOperation=false">
      ...
      <div class="hoveraction" v-show="showOperation"><i class="el-icon-zoom-in" @click="yulan"></i><i class="el-icon-circle-close" @click.stop="handleRemove()"></i></div>
    </div>
    ...
    <div id="movedivs" v-if="yulanshow" ><img :src="dialogImageUrl" alt=""><div class="meng" @click.prevent.stop></div><span class="closebtn"><i class="el-icon-close" @click.stop="yulanshow =false"></i></span></div>
...
export default {
  ...
  methods: {
    ...
    yulan(){
        this.yulanshow = true;
        setTimeout(()=>{
            let odiv = document.getElementById('movedivs')
