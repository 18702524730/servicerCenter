<template>
    ...
    <div class="file-uploader"  @click="addFile">
      <!-- <span class="tipt">点击上传</span> -->
      <!-- <div class="success" v-if="ishtml4&&!startShow">
	  ...
	  <div style="width:100%;height:100%;background:#f9f9f9;" v-if="!ishtml4 && (uploadStatus || progress!=100) && startShow">
		  <el-progress type="circle" :percentage="progress" :status="uploadStatus" :width="94" :stroke-width="4" ></el-progress>
	  </div>
...
<script>
	...
	const Extensions = '3gpp,7z,ac3,asf,au,bmp,bzip2,cab,css,csv,doc,docx,dot,dtd,dwg,dxf,gif,gzip,htm,html,jp2,jpe,jpeg,jpg,js,json,mp2,mp3,mp4,mpeg,mpg,mpp,ogg,psd,pdf,png,pot,pps,ppt,pptx,rar,rtf,svf,tar,tif,tiff,txt,wdb,wim,wps,xhtml,xlc,xlm,xls,xlt,xlw,xml,xz,zip,xlsx,xmind,rp';
    ...
    props:{
      ...
      // action
    	postAction:{
    		type: String,
    		default: rootUrl + '/api/file/uploadAdapt'
    	},
      // name
    	name: {
    		type: String,
...
<style lang='less'>
    ...
    .file-uploader{
      float:left;width:120px;height: 120px;background: #F9F9F9 url(~assets/img/uploader/upload_bg.png) center 40px no-repeat;border: 1px solid #DFE2E5;border-radius: 2px;cursor: pointer;text-align: center;
      .tipt{
