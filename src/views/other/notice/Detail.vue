<template>
	<div class="content_detail">
		<p class="return_last" @click="returnView"><span class="return_icn"><i class="el-icon-arrow-left"></i></span><span class="return_text">返回</span></p>
...
<style lang="less">
	.content_detail{background-color:#fff;padding:30px;
		.return_last{
			...
			i{margin-left: -2px;vertical-align: middle;}
		}
