      ...
      <div class="basic_category clearfix">
        ...
        <div class="itembasic">
          <el-form ref="form1" label-width="270px" :model="addData">
            ...
            <el-form-item label="代理文号：">
              <el-input type="text" v-model="addData.agentNo" placeholder="请填写代理文号" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="申报类别：">
              <el-input type="text" v-model="addData.reportType" placeholder="请填写申报类别"></el-input>
            </el-form-item>
            ...
            <el-form-item  label="申报日期：">
              <el-input type="text" v-model="addData.reportDate" placeholder="请填写申报日期" ></el-input>
            </el-form-item>
            <el-form-item label="申报员：">
              <el-input type="text" v-model="addData.applicationNo" placeholder="请填写申报员" ></el-input>
            </el-form-item>
            <el-form-item label="申请号：">
              <el-input type="text" v-model="addData.trademarkApplicationNo" placeholder="请填写申请号" ></el-input>
            </el-form-item>
            <el-form-item label="开票抬头：">
              <el-input type="text" v-model="addData.billingTitle" placeholder="请填写开票抬头" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="受通短信通知：">
              <el-input type="text" v-model="addData.acceptMessageNotice" placeholder="请填写受通短信通知" ></el-input>
            </el-form-item>
            <el-form-item label="驳回是否收文：">
              <el-input type="text" v-model="addData.rejectWhetherReceipt" placeholder="请填写驳回是否收文" ></el-input>
            </el-form-item>
            <el-form-item label="驳回短信通知：">
              <el-input type="text" v-model="addData.rejectMessageNotice" placeholder="请填写驳回短信通知" ></el-input>
            </el-form-item>
            <el-form-item label="是否驳回复审：">
              <el-input type="text" v-model="addData.whetherRejectReview" placeholder="请填写是否驳回复审" ></el-input>
            </el-form-item>

            <el-form-item label="同日补送证据通知书：" class="spec">
              <el-date-picker
            ...
            <el-form-item label="同日申请协商通知书收文：" class="spec">
              <el-date-picker
            ...
            <el-form-item label="初审短信通知：" >
              <el-input type="text" v-model="addData.firstcheckMessageNotice" placeholder="请填写初审短信通知" ></el-input>
            </el-form-item>
            <el-form-item label="异议答辩通知书收文日期：" class="spec">
              <el-date-picker
                v-model="addData.dissentDefenceReceiptDate"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="异议决定书收文日期：" class="spec">
              <el-date-picker
                v-model="addData.objectionDecisionReceipt"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="商标证二次收文：">
              <el-input type="text" v-model="addData.trademarkSecReceipt" placeholder="请填写商标证二次收文" ></el-input>
            </el-form-item>
            <el-form-item label="商标证短信通知：" >
              <el-input type="text" v-model="addData.trademarkMessageNotice" placeholder="请填写商标证短信通知" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="确认客户收件/回执：">
              <el-input type="text" v-model="addData.confirmConsumer" placeholder="请填写确认客户收件/回执" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="寄件日期：">
              <el-input type="text" v-model="addData.expressTime" placeholder="请填写寄件日期" ></el-input>
            </el-form-item>
    ...
    <div v-show="now==2">
      <div class="basic_lists materialbox">
          ...
          <div class="upload_component" style="margin-bottom:20px;">
            <pasuploader @complete="setUploadedMaterial" @resetUploader="resetUploader" :fileName="standby8_name" :canPreview="false" :postAction="'iprp_servicer/api/uploadFile?offlineType=104&offlineId='+caseSysNo+'&access_token='+token" :url="standby8" :valueName="'standby8'"  :size="10"></pasuploader>
...
const initdata = {
  ...
  "dissentDefenceReceiptDate": "",
  "whetherDissentDefence": "",
  "objectionDecisionReceipt": '',
...
const addurl = './api/createTrademarkRegisteryq'
const detailUrl = './api/selectTrademarkRegisteryq'
export default {
    name:'offlineaddcps',
    data(){
        return{
