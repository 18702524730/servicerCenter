        ...
        <div class="itembasic">
          <el-form ref="form1" label-width="270px" :model="addData">
            ...
            <el-form-item label="提交日期：">
              <el-input type="text" v-model="addData.submitTime" placeholder="请填写提交日期" ></el-input>
            </el-form-item>
            <el-form-item label="序号：">
              <el-input type="text" v-model="addData.seqNo" placeholder="请填写序号" ></el-input>
            </el-form-item>
            <el-form-item label="单号：">
              <el-input type="text" v-model="addData.orderNo" placeholder="请填写单号" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="联系人电话：">
              <el-input type="text" v-model="addData.contactsPhone" placeholder="请填写联系人电话"></el-input>
            </el-form-item>
            ...
            <el-form-item label="申报类别：">
              <el-input type="text" v-model="addData.declareType" placeholder="请填写申报类别"></el-input>
            </el-form-item>
            ...
            <el-form-item label="收款方式：">
              <el-input type="text" v-model="addData.collectionType" placeholder="请填写收款方式"></el-input>
            </el-form-item>
            <el-form-item label="业务审核：">
              <el-input type="text" v-model="addData.businessCheck" placeholder="请填写业务审核"></el-input>
            </el-form-item>
            <el-form-item label="财务确认收款：">
              <el-input type="text" v-model="addData.financialConfirmCollection" placeholder="请填写财务确认收款"></el-input>
            </el-form-item>
            <el-form-item label="收款日期：">
              <el-input type="text" v-model="addData.collectionDate" placeholder="请填写收款日期" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="退款：">
              <el-input type="text" v-model="addData.refund" placeholder="请填写退款" ></el-input>
            </el-form-item>
            <el-form-item label="视为放弃通知书：" class="spec">
              <el-date-picker
                v-model="addData.asAbandonNotice"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="不予受理通知书：" >
              <el-input type="text" v-model="addData.dismissNotice" placeholder="请填写不予受理通知书" ></el-input>
            </el-form-item>
            <el-form-item label="收到受理通知书：" >
              <el-input type="text" v-model="addData.getAcceptNotice" placeholder="请填写收到受理通知书" ></el-input>
            </el-form-item>
            <el-form-item label="不予核准通知书：" >
              <el-input type="text" v-model="addData.notCheckNotice" placeholder="请填写不予核准通知书" ></el-input>
            </el-form-item>
            <el-form-item label="补正通知书：">
              <el-input type="text" v-model="addData.updateNotice" placeholder="请填写补正通知书" ></el-input>
            </el-form-item>
            <el-form-item label="第二次补正通知书：" class="spec">
              <el-date-picker
                v-model="addData.secUpdateNotice"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="驳回通知书：" >
              <el-input type="text" v-model="addData.rejectNotice" placeholder="请填写驳回通知书" ></el-input>
            </el-form-item>
            <el-form-item label="变更、更正商标申请/注册事项申请核准通知书：" class="toolong">
              <el-input type="text" v-model="addData.updateTrademarkApply" placeholder="请填写变更、更正商标申请/注册事项申请核准通知书" ></el-input>
            </el-form-item>
            <el-form-item label="变更证明：">
              <el-input type="text" v-model="addData.changeEvidence" placeholder="请填写变更证明" ></el-input>
            </el-form-item>

            <el-form-item label="续展证明：">
              <el-input type="text" v-model="addData.extensionEvidence" placeholder="请填写续展证明" ></el-input>
            </el-form-item>
            <el-form-item label="转让证明：">
              <el-input type="text" v-model="addData.transExtension" placeholder="请填写转让证明" ></el-input>
            </el-form-item>
            <el-form-item label="初步审定公告：" >
              <el-input type="text" v-model="addData.firstCheckNotice" placeholder="请填写初步审定公告" ></el-input>
            </el-form-item>
            <el-form-item label="异议答辩通知书：">
              <el-input type="text" v-model="addData.dissentDefenceNotice" placeholder="请填写异议答辩通知书" ></el-input>
            </el-form-item>
            <el-form-item label="核准注册：">
              <el-input type="text" v-model="addData.checkRegister" placeholder="请填写核准注册" ></el-input>
            </el-form-item>
            <el-form-item label="注册证：">
              <el-input type="text" v-model="addData.registration" placeholder="请填写注册证" ></el-input>
            </el-form-item>
            <el-form-item label="商标评审申请受通通知书：" class="spec">
              <el-date-picker
                v-model="addData.trademarkCheckNotice"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="驳回复审决定书：">
              <el-input type="text" v-model="addData.rejectReviewDecision" placeholder="请填写驳回复审决定书" ></el-input>
            </el-form-item>
            <el-form-item label="异议决定书：">
              <el-input type="text" v-model="addData.objectionDecision" placeholder="请填写异议决定书" ></el-input>
            </el-form-item>
            <el-form-item label="评审案件结案通知书：">
              <el-input type="text" v-model="addData.reviewCaseNotice" placeholder="请填写评审案件结案通知书" ></el-input>
            </el-form-item>

            <el-form-item label="撤三决定书：">
              <el-input type="text" v-model="addData.recallThreeDecision" placeholder="请填写撤三决定书" ></el-input>
            </el-form-item>
            <el-form-item label="无效宣告请求裁定书收文日期：">
              <el-input type="text" v-model="addData.invalidNoticeDate" placeholder="请填写无效宣告请求裁定书收文日期" ></el-input>
            </el-form-item>
            <el-form-item label="官文收件人：">
              <el-input type="text" v-model="addData.officialRecevier" placeholder="请填写官文收件人" ></el-input>
            </el-form-item>
            <el-form-item label="收件人电话：">
              <el-input type="text" v-model="addData.officialRecevierPhone" placeholder="请填写收件人电话" ></el-input>
            </el-form-item>
            <el-form-item label="收件地址：">
              <el-input type="text" v-model="addData.officialRecevierAddress" placeholder="请填写收件地址" ></el-input>
            </el-form-item>
            <el-form-item label="确认客户收件/回执：">
              <el-input type="text" v-model="addData.confirmConsumerReceive" placeholder="请填写确认客户收件/回执" ></el-input>
            </el-form-item>
            <el-form-item label="快递单号：">
              <el-input type="text" v-model="addData.emailExpressNumber" placeholder="请填写快递单号" ></el-input>
            </el-form-item>
            <el-form-item label="寄件时间：">
              <el-input type="text" v-model="addData.expressTime" placeholder="请填写寄件时间" ></el-input>
            </el-form-item>
            <el-form-item label="邮寄方式：">
              <el-input type="text" v-model="addData.emailType" placeholder="请填写邮寄方式" ></el-input>
            </el-form-item>
            <el-form-item label="备注：">
              <el-input type="text" v-model="addData.remarks" placeholder="请填写备注" ></el-input>
            </el-form-item>

            <el-form-item label="纸报/网报：">
              <el-input type="text" v-model="addData.submitType" placeholder="请填写纸报/网报" ></el-input>
            </el-form-item>
          </el-form>
        </div> 
      </div>
    ...
    <div v-show="now==2">
      <div class="basic_lists materialbox">
          ...
          <div class="upload_component" style="margin-bottom:20px;">
            <pasuploader @complete="setUploadedMaterial" @resetUploader="resetUploader" :fileName="standby8_name" :canPreview="false" :postAction="'iprp_servicer/api/uploadFile?offlineType=106&offlineId='+caseSysNo+'&access_token='+token" :url="standby8" :valueName="'standby8'"  :size="10"></pasuploader>
...
const addurl = './api/createOtherbusinessyq'
const detailUrl = './api/selectOtherbusinessyq'
export default {
