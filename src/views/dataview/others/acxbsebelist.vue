<template>
  <div class="commonList clientServiceOrder">
      ...
      <div class="form_control">
        <el-input v-model="dataObj.ext3" placeholder="平台单号"></el-input>
      </div>
      ...
      <div class="form_control"><el-input v-model="dataObj.ext9" placeholder="服务商代码"></el-input></div>
      <div class="form_control">
...
<script>
  ...
  export default {
    ...
    mounted() {
      let that = this;
      this.setzd()
      let getlist = store.get('cxbsebelist')||this.ziduan;
      this.ziduan = getlist;
    ...
    methods: {
      ...
      setlist(){
        store.set('cxbsebelist',this.ziduan)
      },
      ...
      toaddrecord() {
        this.$router.push({name:'acxbsebeadd',params:{fid:0,id:0}});
      },
      findOrderOriginAll() {
      ...
      findCustPlatformAll() {
        ...
        ret.tbName = 'A_Cxb_Sebe_Declare2016'
      ...
      view(item){
        this.$router.push({name:'acxbsebeadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
      edit(item){
        this.$router.push({name:'acxbsebeadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
