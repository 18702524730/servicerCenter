        ...
        <div class="itembasic">
          <el-form ref="form1" label-width="270px" :model="addData">
            ...
            <el-form-item label="申报人员：">
              <el-input type="text" v-model="addData.reporter" placeholder="请填写申报人员" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="不予受理：" >
              <el-input type="text" v-model="addData.dismissNotice" placeholder="请填写不予受理" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="更正商标申请/注册事项申请核准通知书：">
              <el-input type="text" v-model="addData.updateTrademarkApply" placeholder="请填写更正商标申请/注册事项申请核准通知书" ></el-input>
            </el-form-item>
            <el-form-item label="初步审定公告：" >
              <el-input type="text" v-model="addData.preCheckNitoce" placeholder="请填写初步审定公告" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="快递单号：">
              <el-input type="text" v-model="addData.expressNumber" placeholder="请填写快递单号" ></el-input>
            </el-form-item>
    ...
    <div v-show="now==2">
      <div class="basic_lists materialbox">
          ...
          <div class="upload_component" style="margin-bottom:20px;">
            <pasuploader @complete="setUploadedMaterial" @resetUploader="resetUploader" :fileName="standby8_name" :canPreview="false" :postAction="'iprp_servicer/api/uploadFile?offlineType=107&offlineId='+caseSysNo+'&access_token='+token" :url="standby8" :valueName="'standby8'"  :size="10"></pasuploader>
...
const addurl = './api/createOtherbusinessyl'
const detailUrl = './api/selectOtherbusinessyl'
export default {
