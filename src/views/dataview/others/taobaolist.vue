<template>
  <div class="commonList clientServiceOrder">
      ...
      <div class="form_control">
        <el-input v-model="dataObj.ext3" placeholder="订单编号"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext4" placeholder="需求编号"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext5" placeholder="买家旺旺"></el-input>
      </div>
      
      <div class="form_control"><el-input v-model="dataObj.ext6" placeholder="商标名称"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext7" placeholder="联系人"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext8" placeholder="联系号码"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext9" placeholder="申请人"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext10" placeholder="服务商"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext11" placeholder="代理专员"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext12" placeholder="代理文书"></el-input></div>
...
<script>
  ...
  export default {
    ...
    methods: {
      async findzd(){
        let data = {
          tbName:'Taobao_Service_Market2017_2018'
        }
      ...
      toaddrecord() {
        this.$router.push({name:'taobaoadd',params:{fid:0,id:0}});
      },
      findOrderOriginAll() {
      ...
      findCustPlatformAll() {
        ...
        ret.tbName = 'Taobao_Service_Market2017_2018'
      ...
      view(item){
        this.$router.push({name:'taobaoadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
      edit(item){
        this.$router.push({name:'taobaoadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
