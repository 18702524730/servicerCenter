<template>
  <div class="commonList clientServiceOrder">
      ...
      <div class="form_control">
        <el-input v-model="dataObj.ext4" placeholder="商标名称"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext5" placeholder="联系人"></el-input>
      </div>
      
      <div class="form_control"><el-input v-model="dataObj.ext6" placeholder="联系人号码"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext7" placeholder="申请人"></el-input>
      </div>
      ...
      <div class="form_control"><el-input v-model="dataObj.ext21" placeholder="申请号"></el-input></div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      let that = this;
      this.setzd()
      let getlist = store.get('acxblist')||this.ziduan;
      this.ziduan = getlist;
    ...
    methods: {
      ...
      setlist(){
        store.set('acxblist',this.ziduan)
      },
      ...
      toaddrecord() {
        this.$router.push({name:'acxbadd',params:{fid:0,id:0}});
      },
      findOrderOriginAll() {
      ...
      findCustPlatformAll() {
        ...
        ret.tbName = 'A_Cxb_Declare2018_8'
      ...
      view(item){
        this.$router.push({name:'acxbadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
      edit(item){
        this.$router.push({name:'acxbadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
