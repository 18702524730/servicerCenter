<template>
  <div class="commonList clientServiceOrder">
      ...
      <div class="form_control">
        <el-input v-model="dataObj.ext4" placeholder="订单号"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext7" placeholder="业务员"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext8" placeholder="业务类型"></el-input>
      </div>
      
      <div class="form_control"><el-input v-model="dataObj.ext9" placeholder="专利名称"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext10" placeholder="业务来源"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext11" placeholder="申请人"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext12" placeholder="联系人"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext13" placeholder="联系方式"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext20" placeholder="代理人"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext23" placeholder="申请号"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext31" placeholder="案件当前状态"></el-input></div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      let that = this;
      this.setzd()
      let getlist = store.get('zlqtlist')||this.ziduan;
      this.ziduan = getlist;
    ...
    methods: {
      ...
      setlist(){
        store.set('zlqtlist',this.ziduan)
      },
      ...
      toaddrecord() {
        this.$router.push({name:'zlqtadd',params:{fid:0,id:0}});
      },
      findOrderOriginAll() {
      ...
      findCustPlatformAll() {
        ...
        ret.tbName = 'Patent_Other2018_2019'
      ...
      view(item){
        this.$router.push({name:'zlqtadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
      edit(item){
        this.$router.push({name:'zlqtadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
