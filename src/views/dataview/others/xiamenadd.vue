        ...
        <div class="itembasic">
          <el-form ref="form1" label-width="270px" :model="addData">
            ...
            <el-form-item label="订单号：">
              <el-input type="text" v-model="addData.orderNo" placeholder="请填写订单号" ></el-input>
            </el-form-item>
            ...
            <el-form-item  label="准予注册收文日期：" class="spec">
              <el-date-picker
            ...
            <el-form-item  label="杭州拾贝收-代报费：">
              <el-input type="text" v-model="addData.sebeCollection" placeholder="请填写杭州拾贝收-代报费" ></el-input>
            </el-form-item>
            <el-form-item  label="代报费收款日期：" class="spec">
              <el-date-picker
                v-model="addData.agencyFeeDate"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="不予受理：" class="spec">
              <el-date-picker
                v-model="addData.dismissDate"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="受通是否收文：" class="spec">
              <el-date-picker
                v-model="addData.acceptWhetherUpload"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="审查意见通知书收文日期：">
              <el-input type="text" v-model="addData.checkIdeaNoticeReceipt" placeholder="请填写审查意见通知书收文日期" ></el-input>
            </el-form-item>
            <el-form-item label="初审是否收文："  class="spec">
              <el-date-picker
                v-model="addData.firstcheckWhetherReceipt"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="是否异议答辩："  class="spec">
              <el-date-picker
                v-model="addData.whetherDissentDefence"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="快递单号：">
              <el-input type="text" v-model="addData.expressNo" placeholder="请填写寄件快递单号" ></el-input>
            </el-form-item>
            <el-form-item label="寄件时间：" class="spec">
              <el-date-picker
                v-model="addData.emailTime"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            <!-- <el-form-item label="创建人：">
              <el-input type="text" v-model="addData.creatorOne" placeholder="请填写创建人" ></el-input>
            </el-form-item>
            <el-form-item label="创建时间：" class="spec">
              <el-date-picker
                v-model="addData.createTimeOne"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="修改人">
              <el-input type="text" v-model="addData.updatePersonOne" placeholder="请填写备注" ></el-input>
            </el-form-item>
            <el-form-item label="修改时间：" class="spec">
              <el-date-picker
                v-model="addData.updateTimeOne"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="最后活动时间：" class="spec">
              <el-date-picker
    ...
    <div v-show="now==2">
      <div class="basic_lists materialbox">
          ...
          <div class="upload_component" style="margin-bottom:20px;">
            <pasuploader @complete="setUploadedMaterial" @resetUploader="resetUploader" :fileName="standby8_name" :canPreview="false" :postAction="'iprp_servicer/api/uploadFile?offlineType=109&offlineId='+caseSysNo+'&access_token='+token" :url="standby8" :valueName="'standby8'"  :size="10"></pasuploader>
...
const addurl = './api/createXiamenTrademarkRegister'
const detailUrl = './api/selectXiamenTrademarkRegister'
export default {
    name:'xiamenaddcps',
    data(){
        return{
