    ...
    <div v-show="now==2">
      <div class="basic_lists materialbox">
          ...
          <div class="upload_component" style="margin-bottom:20px;">
            <pasuploader @complete="setUploadedMaterial" @resetUploader="resetUploader" :fileName="standby8_name" :canPreview="false" :postAction="'iprp_servicer/api/uploadFile?offlineType=127&offlineId='+caseSysNo+'&access_token='+token" :url="standby8" :valueName="'standby8'"  :size="10"></pasuploader>
    ...
    methods:{
      ...
      tosubmit(){
        ...
        if(this.isNull(data)){
          ...
          data.tbName = 'Taobao_Service_Market2017_2018'
