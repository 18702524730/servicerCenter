<template>
  <div class="commonList clientServiceOrder">
      ...
      <div class="form_control">
        <el-input v-model="dataObj.ext9" placeholder="合同签订人"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext10" placeholder="业务来源"></el-input>
      </div>
      
      <div class="form_control"><el-input v-model="dataObj.ext11" placeholder="联系人"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext12" placeholder="手机号"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext15" placeholder="专利名称"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext16" placeholder="案件当前状态"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext18" placeholder="申请人"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext33" placeholder="代理人"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext35" placeholder="申请号"></el-input></div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      let that = this;
      this.setzd()
      let getlist = store.get('zlyllist')||this.ziduan;
      this.ziduan = getlist;
    ...
    methods: {
      ...
      setlist(){
        store.set('zlyllist',this.ziduan)
      },
      ...
      toaddrecord() {
        this.$router.push({name:'zlyladd',params:{fid:0,id:0}});
      },
      findOrderOriginAll() {
      ...
      view(item){
        this.$router.push({name:'zlyladd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
      edit(item){
        this.$router.push({name:'zlyladd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
