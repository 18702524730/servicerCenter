<template>
  <div class="commonList clientServiceOrder">
      ...
      <div class="form_control">
        <el-input v-model="dataObj.ext6" placeholder="订单号"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext7" placeholder="递交机构"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext9" placeholder="业务员"></el-input>
      </div>
      
      <div class="form_control"><el-input v-model="dataObj.ext10" placeholder="业务类型"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext11" placeholder="专利名称"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext12" placeholder="业务来源"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext13" placeholder="申请人"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext14" placeholder="联系人"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext15" placeholder="联系方式"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext23" placeholder="代理人"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext26" placeholder="申请号"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext30" placeholder="案件当前状态"></el-input></div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      let that = this;
      this.setzd()
      let getlist = store.get('zlpctlist')||this.ziduan;
      this.ziduan = getlist;
    ...
    methods: {
      ...
      setlist(){
        store.set('zlpctlist',this.ziduan)
      },
      ...
      toaddrecord() {
        this.$router.push({name:'zlpctadd',params:{fid:0,id:0}});
      },
      findOrderOriginAll() {
      ...
      view(item){
        this.$router.push({name:'zlpctadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
      edit(item){
        this.$router.push({name:'zlpctadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
