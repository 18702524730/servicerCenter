        ...
        <div class="itembasic">
          <el-form ref="form1" label-width="270px" :model="addData">
            ...
            <el-form-item label="商标申请号：">
              <el-input type="text" v-model="addData.trademarkApplicationNo" placeholder="请填写商标申请号" ></el-input>
            </el-form-item>
            <el-form-item  label="上传申请号回执单：">
              <el-input type="text" v-model="addData.uploadApplicationNo" placeholder="请填写上传申请号回执单" ></el-input>
            </el-form-item>
            <el-form-item label="核账人：">
              <el-input type="text" v-model="addData.checkMan" placeholder="请填写核账人" ></el-input>
            </el-form-item>
            ...
            <el-form-item label="收到受理通知书：" class="spec">
              <el-date-picker
                v-model="addData.getAcceptNotice"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="初审收文日期：" class="spec">
              <el-date-picker
                v-model="addData.firstcheckReceiptDate"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="异议答辩收文：" class="spec">
              <el-date-picker
                v-model="addData.dissentDefenceReceipt"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="异议决定书收文：">
              <el-input type="text" v-model="addData.objectionDecisionReceipt" placeholder="请填写异议决定书收文" ></el-input>
            </el-form-item>
            <el-form-item label="商标证是否收文：" class="spec">
              <el-date-picker
                v-model="addData.trademarkWhetherReceipt"
                type="date"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
    ...
    <div v-show="now==2">
      <div class="basic_lists materialbox">
          ...
          <div class="upload_component" style="margin-bottom:20px;">
            <pasuploader @complete="setUploadedMaterial" @resetUploader="resetUploader" :fileName="standby8_name" :canPreview="false" :postAction="'iprp_servicer/api/uploadFile?offlineType=105&offlineId='+caseSysNo+'&access_token='+token" :url="standby8" :valueName="'standby8'"  :size="10"></pasuploader>
...
const initdata = {
  ...
  "whetherRejectReview": "",
  "firstcheckReceiptDate": "",
  "firstcheckMessageNotice": '',
  "dissentDefenceReceipt": "",
...
const addurl = './api/createTrademarkRegisteryl'
const detailUrl = './api/selectTrademarkRegisteryl'
export default {
    name:'offlinexaddcps',
    data(){
        return{
