<template>
  <div class="commonList clientServiceOrder">
      ...
      <div class="form_control">
        <!-- <el-input v-model="dataObj.ext6" placeholder="专利类型"></el-input> -->
        <el-select  v-model="dataObj.ext6" placeholder="专利类型">
      ...
      <div class="form_control">
        <el-input v-model="dataObj.ext7" placeholder="订单号"></el-input>
      </div>
      <div class="form_control">
        <el-input v-model="dataObj.ext11" placeholder="业务员"></el-input>
      </div>
      
      <div class="form_control"><el-input v-model="dataObj.ext12" placeholder="业务来源"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext13" placeholder="联系人"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext14" placeholder="手机号"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext17" placeholder="专利名称"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext18" placeholder="案件当前状态"></el-input></div>
      <div class="form_control">
        <el-input v-model="dataObj.ext20" placeholder="申请人"></el-input>
      </div>
      <div class="form_control"><el-input v-model="dataObj.ext42" placeholder="代理人"></el-input></div>
      <div class="form_control"><el-input v-model="dataObj.ext47" placeholder="申请号"></el-input></div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      let that = this;
      this.setzd()
      let getlist = store.get('beijinglist')||this.ziduan;
      this.ziduan = getlist;
    ...
    methods: {
      ...
      setlist(){
        store.set('beijinglist',this.ziduan)
      },
      ...
      toaddrecord() {
        this.$router.push({name:'bjadd',params:{fid:0,id:0}});
      },
      findOrderOriginAll() {
      ...
      findCustPlatformAll() {
        ...
        ret.tbName = 'Beijing_Declare_Hangzhou_Case'
      ...
      view(item){
        this.$router.push({name:'bjadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
      edit(item){
        this.$router.push({name:'bjadd',params:{fid:item.dataUniqueNumber,id:item.id}});
      },
