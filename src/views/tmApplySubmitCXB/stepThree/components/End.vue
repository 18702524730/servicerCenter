<template>
	<div class="end_basic_cxb" v-loading="loading" element-loading-text="拼命加载中">
...
<script>
    ...
    methods: {
      ...
      saveDraft(){
      	...
      	this.infoDetailData.confirm_step = 2;
...
<style lang='less'>
	.end_basic_cxb{background-color:#fff;padding:30px;border-radius: 0 2px 2px 2px;min-height: 500px;
